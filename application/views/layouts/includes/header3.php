    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
       <div class="container">
           ...
           <span class="icon-bar"></span>
            ...
            <a class="navbar-brand" href="<?=base_url('')?>">CMan Admin Page</a> 
             <div class="navbar-collapse collapse">

                <ul class="nav navbar-nav navbar-left">
                  <li class="active"><a href="<?=base_url('')?>">Home</a></li>    
              
                  <li class=""><a href="<?=base_url ('')?>">Create an Account</a></li>


                  
                </ul>
                <?php echo form_open_multipart('products/admin_login', ['class'=>'navbar-form navbar-right']);?>
