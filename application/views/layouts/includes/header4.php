    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
       <div class="container">
           ...
           <span class="icon-bar"></span>
            ...
            <a class="navbar-brand" href="<?=base_url('admin_page')?>">CMan Admin</a> 
             <div class="navbar-collapse collapse">

                <ul class="nav navbar-nav navbar-left">
                  <li class="active"><a href="<?=base_url('admin_page')?>">Home</a></li>    
              
                  <li class=""><a href="<?=base_url('admin_page/newupload')?>">New Upload</a></li> 
                  <li class=""><a href="<?=base_url('admin_page/uploads')?>">My Uploads</a></li>  
